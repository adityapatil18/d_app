...
class Recived2Entry2Screen2 extends StatefulWidget {
  const Recived2Entry2Screen2({super.key});

  @override
  State<Recived2Entry2Screen2> createState() => _Recived2Entry2Screen2State();
}

class _Recived2Entry2Screen2State extends State<Recived2Entry2Screen2> {
